...
#CommentSBATCH --nodelist=tikgpu05 # Specify that it should run on this particular node
...
--warmup_epochs 200 \
--test_every 10 \
--checkpoint_path ./models/CIFAR10Dequantized-f748accd35ec421c8a1b2adf0218d862/
